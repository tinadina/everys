...
public class DonSignInActivity extends AsyncTask<String, Void, String> {
    private Context context;
    String login;
    public DonSignInActivity(Context context){
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            link = "http://truffel.000webhostapp.com/signin.php"+data;
        ...
        if(jsonStr!=null){
            try{
                ...
                if(query_result.equals("SUCCESS")){
                    Intent intent= new Intent(context, DestitActivity.class);
